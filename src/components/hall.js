...
{/*    CARD DE DETALHES DO PEDIDO */}
    <section className="order-card">
      ...
      <div className="order-details">
        <p>Nº do pedido: {}</p>
        <p>
          Nº da mesa: <input className="order-details-input input" placeholder="Insira o nº da mesa" required></input>
        </p>
        <p>
          Cliente: <input className="order-details-input input" placeholder="Insira o nome do cliente" required></input>
        </p>
      </div>
